...
# Calculates the specific heat for a <class 'ase.lattice.bravais.Lattice'>. Returns a value with dimensions J/(K*Kg)
# Something wrong with this function. For a bigger crystal the specific heat eneregy is lowered. It should be the opposite.
# Should require more energy to heat up a larger sample. Unclear what causes this. Is it wrong to use the total energy? Is the Langevin function corret? 
...
def Specific_Heat(atoms):
    ...
    for i in range(2):
        ...
        #print("The temperature vector is:" ,temp_vec)
        #print("The energy vector is:" ,eng_vec)
